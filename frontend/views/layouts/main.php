        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="/doctors">Каталог врачей</a></li>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="well well-trans">
                            <div class="wow fadeInRight" data-wow-delay="0.1s">
                                ...
                                <div class="form-group main-search-block">
                                    <form action="search">
                                        <div class="col-xs-12">
                                            <input class="form-control input-lg" name="query" id="" type="text" placeholder="Специальность или фамилия врача">
                                        </div>
                                        <div class="col-xs-4">
                                            <input type="submit" class="btn-success btn-lg" id="" value="Поиск">
                                        </div>
                                    </form>
                                </div>
                            </div>
